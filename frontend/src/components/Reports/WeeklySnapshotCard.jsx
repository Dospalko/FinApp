...
import { FaArrowUp, FaArrowDown, FaBullseye, FaCheckCircle, FaInfoCircle, FaChevronDown, FaChevronUp } from 'react-icons/fa';
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                exit="exit"
                layout
                className="bg-gradient-to-br from-white via-gray-50 to-gray-100 rounded-xl shadow-lg border border-gray-200 mb-6 sm:mb-8"
            >
                <div 
                    className="p-4 flex justify-between items-center cursor-pointer hover:bg-gray-50 rounded-t-xl"
                            ...
                            {!isLoading && !error && snapshotData && (
                                <>
                                    <h3 className="text-sm text-gray-600 mb-4">
                                        {formatDate(snapshotData.start_date_range)} - {formatDate(snapshotData.end_date_range)}
                                    </h3>
